...
export default function Home() {
  ...
  return (
    <div className={`${roboto.className} bg-white text-black`}>
      ...
      <nav className="flex mx-6 md:mx-0 justify-between md:justify-around py-1 md:p-6 items-center">
        <div>
      ...
      <hr className="border-2 border-gray-800 my-6 md:hidden " />
      <main>
        <section
          id="home"
